...
bool calculate_azimuth_elevation(uint8_t station_number, uint32_t index_1, uint32_t index_2, float *azimuth, float *elevation)
{
  ...
  if((index_2 - index_1) < BEAM_INDEX_DIFFERENCE)
  {
  ...
  raw_angle_index_unshifted_1 = ((float)index_1 / periods[station_number]) * 2.0 * PI;
  raw_angle_index_unshifted_2 = ((float)index_2 / periods[station_number]) * 2.0 * PI;
  ...
  angle_index_1 = ((float)index_1 / periods[station_number]) * 2.0 * PI;
  angle_index_2 = ((float)index_2 / periods[station_number]) * 2.0 * PI;
  */
  ...
  *elevation = atan(sin(b / 2.0) / tan(p / 2.0));
