...
void record_calib(uint8_t bit)
{
  ...
  if(decoder.save_bits == 1)
  {
    ...
    if(decoder.received_bits == BITS_PER_CALIBRATION)
    {
      ...
      {
        // compare both consecutive received bitstreams and save to struct if the match
...
// calibration usage:
// could be used for later extension with all parameters:
//# calibration used in libsurvive: https://github.com/cntools/libsurvive/blob/master/src/survive_reproject_gen2.c#L114 - all parameters
//# calibration used in cf: https://www.bitcraze.io/about/events/documents/tutorial_demo_presentation.pdf - we use this here


// ===================================================================================================
// ===== CALIBRATION USAGE TO CORRECT ANGLES WHICH IS THE SAME AS IN THE CRAZYFLIE FROM BITCRAZE =====
// ===================================================================================================
